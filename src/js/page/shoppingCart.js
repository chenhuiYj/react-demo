                        ...
                        this.state.shoppingList.map((item,index)=>{
                            ...
                            <td className="td-num">
                                <div className="product-num">
                                    <a href="javascript:;" className="num-reduce num-do fl" onClick={()=>{}}><span></span></a>
                                        <input type="text" className="num-input" v-model="item.pro_num"/>
                                        <a href="javascript:;" className="num-add num-do fr" onClick={()=>{}}><span></span></a>
                                        </div>
                                        </td>
                                        <td className="td-price">
                                        <p className="red-text">￥<span className="price-text">{item.pro_price}</span></p>
                                        </td>
                                        <td className="td-total">
                                        <p className="red-text">￥<span className="total-text">{item.pro_price*item.pro_num}</span>.00</p>
                                        </td>
